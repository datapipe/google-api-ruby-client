  ...
  module Apis
    module AndroiddeviceprovisioningV1
      ...
      class AndroidProvisioningPartnerService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def claim_partner_device(partner_id, claim_device_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def unclaim_partner_device(partner_id, unclaim_device_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
