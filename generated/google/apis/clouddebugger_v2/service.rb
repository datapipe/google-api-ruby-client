  ...
  module Apis
    module ClouddebuggerV2
      ...
      class CloudDebuggerService < Google::Apis::Core::BaseService
        ...
        def register_controller_debuggee(register_debuggee_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def update_controller_debuggee_breakpoint(debuggee_id, id, update_active_breakpoint_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
