  ...
  module Apis
    module ServiceuserV1
      ...
      class ServiceUserService < Google::Apis::Core::BaseService
        ...
        def disable_project_service(name, disable_service_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def enable_project_service(name, enable_service_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
