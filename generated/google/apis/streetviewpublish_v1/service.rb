  ...
  module Apis
    module StreetviewpublishV1
      ...
      class StreetViewPublishService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def batch_photo_delete(batch_delete_photos_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def batch_photo_update(batch_update_photos_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
