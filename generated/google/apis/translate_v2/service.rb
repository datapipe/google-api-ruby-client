  ...
  module Apis
    module TranslateV2
      ...
      class TranslateService < Google::Apis::Core::BaseService
        ...
        def detect_detection(detect_language_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def translate_translation(translate_text_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
